...
Code sketches under the locked frame.

## Closed

- [`e0-quasistatic-parcel/`](e0-quasistatic-parcel/) — **E.** Single parcel. PASS.
- [`g0-euclidean-cubes/`](g0-euclidean-cubes/) — **G.** Face-gated volume transfer. PASS.
...
- [`gh-harness-chain/`](gh-harness-chain/) — **G+H.** Hold on chain, face hops. PASS.
